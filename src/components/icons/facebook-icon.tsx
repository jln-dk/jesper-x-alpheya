  ...
  return (
    ...
    >
      <g clipPath="url(#a)">
        ...
        <path
          fill="#fff"
          d="M16.671 15.469 17.203 12h-3.328V9.75c0-.95.465-1.875 1.956-1.875h1.513V4.922s-1.374-.234-2.687-.234c-2.74 0-4.532 1.66-4.532 4.668V12H7.078v3.469h3.047v8.385a12.087 12.087 0 0 0 3.75 0V15.47h2.796Z"
        />
      </g>
      <defs>
        <clipPath id="a">
